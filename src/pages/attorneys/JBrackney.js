...
export default function JBrackney() {
  return (
    ...
    <div className="'left-column">
        ...
        <p>
            Mr. Brackney attended law school at the Georgia State University College of Law where, in addition to his
            Juris Doctorate, he received a Certificate in Health Law, with honors, and graduated with highest
            distinction for pro bono service. During his law school career, Mr. Brackney was twice selected as an extern
            with the Centers for Disease Control and Prevention, working for the Office of the General Counsel during
            his second year, and the Public Health Law Program in his third year. Mr. Brackney was also a Graduate
            Assistant for the Director of the Center for Law, Health and Society, Leslie E. Wolf, and member of the
            Health Law Regulatory and Compliance competition team.
        </p>

        <p> 
            Before joining Fixler & LaGattuta, Mr. Brackney worked for well-known New York City firm specializing in
            medical malpractice defense, where he litigated cases on behalf of many of New York’s premier hospitals
        </p>
